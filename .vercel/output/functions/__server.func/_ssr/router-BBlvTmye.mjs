...
const useFluidCursor = () => {
  reactExports.useEffect(() => {
    ...
    function getWebGLContext(canvas2) {
      ...
      if (!gl2) return { gl: null, ext: null };
      let halfFloat;
...
function RootDocument({ children }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("html", { lang: "en", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("body", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("canvas", { id: "fluid" }),
      children,
      /* @__PURE__ */ jsxRuntimeExports.jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$2 = () => import("./register-C2a6p1WV.mjs");
...
const Route = createFileRoute("/api/sync-to-sheets")({
  server: {
    handlers: {
      POST: async ({ request }) => {
        try {
...
const ProductsProductIdRoute = Route$1.update({
  id: "/products/$productId",
  path: "/products/$productId",
  getParentRoute: () => Route$4
});
const ApiSyncToSheetsRoute = Route.update({
